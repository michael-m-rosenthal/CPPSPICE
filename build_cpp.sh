...
g++ $src_dir/Occultations2.cpp -I$local_include_dir -c -O2 -std=c++11 -o $build_dir/Occultations2.o
g++ $src_dir/lowLevel.cpp -I$local_include_dir -c -O2 -std=c++11 -o $build_dir/lowLevel.o
...
g++ $src_dir/occfind2.cpp $build_dir/Occultations2.o $build_dir/lowLevel.o -I$local_include_dir -B static $local_lib_dir/cspice.a -O2 -std=c++11 -o $bin_dir/occfind2
