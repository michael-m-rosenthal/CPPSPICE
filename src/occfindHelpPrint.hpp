...
namespace spice
{
  ...
  */
  ...
  void PrintHelp(){
    ...
    std::cout << "occfind CLI" << std::endl;
    std::cout << lineBorder << std::endl;
    // print brief description
    std::cout << "occfind locates solar occultations (the moon blocks the sun as seen from earth)." << std::endl<< std::endl;
    // print slightly more detailed description
    std::cout << "By default, it is assumed that the observer is located at the center of the Earth and that the Earth somehow does not obstruct the observer from viewing the event for the occultation calculation. ";
    std::cout << "This means that certain occultations (usually near the north or south poles) will not be returned. ";
    std::cout << std::endl;
    std::cout << lineBorder << std::endl;
    // describe how the function is called
    std::cout << "Usage:  occfind [OPTION]"<< std::endl;
    std::cout << lineBorder << std::endl;
    // describe options
    ...
    std::cout << "--help -h";
    std::cout << "\n\t\t";
    std::cout << "Print help for using the occfind CLI";
    std::cout   << std::endl;
    ////////////////////////////////////////////////////////////////////////////
    std::cout << "\t";
    std::cout << "--lsk -l ";
    ...
    std::cout << "\n\n\t\t";
    std::cout << "If OCCFIND_DATA_PATH is empty, then occfind assumes OCCFIND_DATA_PATH=./data/";
    ...
    ////////////////////////////////////////////////////////////////////////////
      std::cout << "\n\n\tExample Usage: \n\t";
    std::cout << "occfind -b \"2017 AUG 21\" -e \"2017 AUG 22\" "<< std::endl;
    std::cout << "\n\t\t";
    std::cout << "This will find solar occultations between  \"2017 AUG 21\" and  \"2017 AUG 22\"";
    std::cout << std::endl;
    ////////////////////////////////////////////////////////////////////////////
    std::cout << "\n\n\tExample Usage: \n\t";
    std::cout << "occfind  -l ~/oldspicedata/naif0008.tls -s ~/oldspicedata/de421.bsp -p ~/oldspicedata/pck00008.tpc"<< std::endl;
    std::cout << "\n\t\t";
